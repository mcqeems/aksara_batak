...
const Sejarah: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const advance = () => {
      ...
      // There are 15 content items, plus 1 intro section. So 16 sections total (0-15).
  ...
  useEffect(() => {
    ...
    document.body.classList.add('sejarah-page-active');
    document.documentElement.classList.add('sejarah-page-active');
    ...
    return () => {
      document.body.classList.remove('sejarah-page-active');
      document.documentElement.classList.remove('sejarah-page-active');
    ...
    function initializeAnimations(splitHeadings: (SplitText | null)[]) {
      ...
      function gotoSection(index: number, direction: number) {
        ...
        if (sections[index]) {
          ...
          const imageConfigs = [
            { id: 'jejak-awal-img', index: 1, direction: 'up' },
            { id: 'evolusi-lokal-img', index: 2, direction: 'left' },
            { id: 'para-datu-img', index: 3, direction: 'right' },
            { id: 'fungsi-magis-img', index: 4, direction: 'left' },
            { id: 'varian-aksara-img', index: 5, direction: 'right' },
            { id: 'pengaruh-islam-img', index: 6, direction: 'right' },
            { id: 'zaman-kolonial-img', index: 7, direction: 'right' },
            { id: 'dokumentasi-img', index: 8, direction: 'left' },
            { id: 'menjelang-kepunahan-img', index: 9, direction: 'right' },
            { id: 'kebangkitan-img', index: 10, direction: 'left' },
            { id: 'era-digital-img', index: 11, direction: 'right' },
            { id: 'struktur-aksara-img', index: 12, direction: 'left' },
            { id: 'media-tradisional-img', index: 13, direction: 'right' },
  ...
  return (
    <div className="sejarah-page bg-background text-foreground min-h-screen overflow-hidden">
      <ScrollingNavbar
        onAutoScrollToggle={handleAutoScrollToggle}
        onSoundToggle={handleSoundToggle}
        onSectionChange={handleSectionChange}
        currentSection={currentSection}
        totalSections={batakNarrationContent.length + 1}
