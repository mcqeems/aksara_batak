...
export function AnimatedBackground() {
  return (
    <div className="absolute inset-0 z-0">
      ...
      />
      <motion.div
        className="bg-destructive/20 absolute -bottom-40 -left-40 h-80 w-80 rounded-full blur-3xl"
      ...
      />
      <motion.div
        className="bg-primary/30 absolute top-10 left-1/2 h-40 w-40 rounded-full blur-2xl"
      ...
      />
      <motion.div
        className="bg-destructive/30 absolute right-1/3 bottom-20 h-32 w-32 rounded-full blur-2xl"
      ...
      />
      <motion.div
        className="bg-primary/10 absolute top-1/3 left-10 h-24 w-24 rounded-full blur-2xl"
        style={{ backgroundColor: 'rgba(236, 187, 136, 0.1)' }}
        animate={{
          scale: [1, 1.15, 1],
          opacity: [0.2, 0.5, 0.2],
        }}
      ...
      />
      <motion.div
        className="bg-destructive/10 absolute bottom-1/4 left-1/2 h-28 w-28 rounded-full blur-2xl"
        style={{ backgroundColor: 'rgba(255, 102, 102, 0.1)' }}
        animate={{
          scale: [1, 1.05, 1],
          opacity: [0.1, 0.4, 0.1],
        }}
